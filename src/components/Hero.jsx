...
const SERVICES = [
  { name: 'Nail Art', img: 'https://images.unsplash.com/photo-1604654894610-df49065027ae?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Laser Diodo', img: 'https://images.unsplash.com/photo-1559599189-fe84dea4eb79?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Corpo Green', img: 'https://images.unsplash.com/photo-1544161515-4af6b1d46afb?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Estetica Base', img: 'https://images.unsplash.com/photo-1512290923902-8a9f81dc2069?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Manicure', img: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Viso 100% Bio', img: 'https://images.unsplash.com/photo-1570172619114-d101797e8f10?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Nail Design', img: 'https://images.unsplash.com/photo-1610992015732-2449b0deec5d?w=200&h=200&q=80&auto=format&fit=crop' },
  { name: 'Pedicure', img: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=200&h=200&q=80&auto=format&fit=crop' },
]
    ...
    >
      <div
        style={{
          ...
          flexShrink: 0,
          backgroundColor: isMobileScale ? '#fef6fe' : '#fdf2fd', // Fallback background color
          display: 'flex',
          alignItems: 'center',
      ...
      <div className="relative w-full" style={{ 
        ...
        >
          ...
          >
            ...
            >
              Trattamenti viso e corpo 100% green <br className="hidden md:block" />
              e tecnologie laser all'avanguardia
            </motion.p>
          </div>
