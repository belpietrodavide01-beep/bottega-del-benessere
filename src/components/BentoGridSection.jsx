      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        >
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-center text-white/90 text-[11px] font-medium tracking-wide">
                  <span className="flex items-center gap-2 w-1/2 shrink-0"><Calendar size={14} strokeWidth={2.5} /> 8 Settimane</span>
            ...
            >
              ...
              >
                <span className="w-9 h-9 rounded-full flex items-center justify-center bg-white shadow-sm duration-300">
                  <ArrowUpRight size={16} strokeWidth={2.5} className="text-[#d565d9]" />
                </span>
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            >
              <div className="absolute text-[10rem] font-serif text-[#d565d9]/[0.05] bottom-[-3rem] right-[-1rem] leading-none whitespace-nowrap select-none pointer-events-none" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
                2016
              </div>
              ...
              <div className="flex flex-wrap gap-2.5 z-10">
                ...
                <span className="px-4 py-1.5 bg-white/90 border border-[#d565d9]/20 rounded-full text-[11px] font-bold tracking-wider text-[#d565d9] uppercase shadow-sm">50+ Trattamenti</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center mb-6 z-10 bg-[#fdfcfb]">
                <div className="flex items-center gap-1 mb-2">
                  {[...Array(5)].map((_, i) => <Star key={i} size={16} className="fill-[#d565d9] text-[#d565d9]" />)}
                </div>
                  ...
                  {REVIEWS.map((r) => (
                    <div key={`a-${r.id}`} className="bg-white border border-stone-100 rounded-2xl p-5 shadow-sm flex flex-col gap-3 shrink-0">
                      <div className="flex items-center gap-0.5">
                        {[...Array(5)].map((_, i) => <Star key={i} size={10} className="fill-[#d565d9] text-[#d565d9]" />)}
                      </div>
