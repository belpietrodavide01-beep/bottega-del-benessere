...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#fef6fe] pt-16 md:pt-24 pb-12 px-6 lg:px-16 border-t border-stone-200/60">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-20">
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col items-start text-left gap-6 border-b border-stone-200/40 pb-12 lg:border-0 lg:pb-0">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full border border-stone-200 flex items-center justify-center text-stone-600 hover:bg-[#d565d9] hover:text-white hover:border-[#d565d9] transition-all"
              >
                <Instagram size={18} />
              </a>
            </div>
              ...
              {['Chi Siamo', 'Servizi', 'Recensioni', 'FAQ', 'Contatti'].map((link) => (
                <li key={link}>
                  <button 
                    ...
                    className="text-stone-500 text-sm hover:text-[#d565d9] transition-colors flex items-center gap-2 group"
                  >
                    {link}
            ...
            <ul className="flex flex-col gap-5 items-start">
              <li>
                <a href="tel:+393473127375" className="flex items-start gap-3 group">
                  <Phone size={18} className="text-[#d565d9] shrink-0" />
              ...
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-[#d565d9] shrink-0" />
                <div className="flex flex-col items-center md:items-start">
                  <span className="text-black font-medium text-sm">Via S. Lorenzo, 122</span>
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col items-start text-left gap-6 pt-12 lg:pt-0 border-t border-stone-200/40 lg:border-0 w-full">
            ...
            <div className="mt-4 p-4 rounded-2xl bg-[#fffaff] border border-[#d565d9]/10 flex items-start gap-3">
              <Clock size={16} className="text-[#d565d9] mt-0.5" />
        ...
        <div className="pt-12 border-t border-stone-200/60 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-stone-400 text-[11px] tracking-wide uppercase">
            &copy; {currentYear} La Bottega del Benessere — Tutti i diritti riservati
          </p>
