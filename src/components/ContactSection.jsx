      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
          ...
          >
            ...
            <a 
              ...
              className="w-full sm:w-auto group flex items-center gap-3 pl-2 pr-8 py-2 rounded-full bg-[#d565d9] border border-[#d565d9] hover:bg-[#b04cad] transition-all duration-300 shadow-xl hover:shadow-2xl active:scale-95"
            >
              <span className="w-12 h-12 rounded-full flex items-center justify-center bg-white shadow-sm duration-300">
                <Phone size={20} className="text-[#d565d9]" />
              </span>
        ...
        <div className="w-full lg:w-1/2 flex flex-col relative" ref={mapRef}>
          ...
          >
            {isInView ? (
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2794.0198398107573!2d10.4335923!3d45.3887706!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4781bd0ac93d028d:0xa2ea96b08472ccae!2sLa%20Bottega%20del%20Benessere%20di%20Castellani%20Cinzia!5e0!3m2!1sit!2sit!4v1713621435000!5m2!1sit!2sit"
